...
message.style.height = Number.parseFloat(getComputedStyle.height, 10) + 40 + 'px';
...
const alertH1 = function(e) {
  alert('adEventListener: Great! You are reading the heading! :D');
...
console.log(h1.childNodes); //direct childrens
...
const createDots = function() {
  slides.forEach(function(s, i) {
    dotContainer.insertAdjancentHTML('beforeend', `<button class="dots__dot" data-slide="${i}"></button>`);
  });
};
createDots();
